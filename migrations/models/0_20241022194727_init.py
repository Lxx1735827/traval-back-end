...
async def upgrade(db: BaseDBAsyncClient) -> str:
    ...
    `description` VARCHAR(1000)   COMMENT '景点简介',
    ...
    `ticket` VARCHAR(1000)   COMMENT '景点门票',
    `open_time` VARCHAR(1000)   COMMENT '景点开放时间',
    `longitude` DECIMAL(9,6) NOT NULL  COMMENT '经度',
    `latitude` DECIMAL(9,6) NOT NULL  COMMENT '纬度',
    `review_1` LONGTEXT   COMMENT '景点评论',
    `review_2` LONGTEXT   COMMENT '景点评论',
    `review_3` LONGTEXT   COMMENT '景点评论',
    `review_4` LONGTEXT   COMMENT '景点评论',
    `review_5` LONGTEXT   COMMENT '景点评论'
